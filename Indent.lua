...
local format, wipe, select, next = _G.format, _G.wipe, _G.select, _G.next
local GetTime = _G.GetTime
local tableconcat = _G.table.concat
local stringlen = _G.string.len
local stringfind = _G.string.find
local stringsub = _G.string.sub
local stringbyte = _G.string.byte
local stringrep = _G.string.rep
...
function lib.colorCodeCode(code, caretPosition)
  ...
  return tableconcat(workingTable), newCaretPosition, numLines
end
...
function lib.indentCode(code, tabWidth, caretPosition)
  ...
  return tableconcat(workingTable), newCaretPosition
end
